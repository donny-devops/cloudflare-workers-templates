...
# The GHCR publish workflow builds ./Dockerfile. This image compiles the
# Vite + Cloudflare Worker bundle, then serves it locally with wrangler so
# the SPA and Workflows/Durable Objects APIs work in the container.
